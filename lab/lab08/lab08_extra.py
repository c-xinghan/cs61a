...
class Keyboard:
    ...
    def __init__(self, *args):
        ...
        # alternate one-line solution using dict comprehension
...
def make_advanced_counter_maker():
    ...
    def inner_1():
        ...
        def inner_2(message):
            ...
            messages = {
                "count": (count, "local"), 
                "global-count": (count, "global"),
                "reset": (reset, "local"),
                "global-reset": (reset, "global")}

            return messages.get(message)[0](messages.get(message)[1])
...
def shuffle(cards):
    ...
    for i in half:
        shuffled.append(i)
        shuffled.append(cards[half.index(i) + int(len(cards)/2)])
    return shuffled
